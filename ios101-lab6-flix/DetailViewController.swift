...
//  ios101-lab6-flix
//
//  Created by Hanami Do on 10/17/23.
//
...
class DetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // convert releaseDate (type Date) to string
        let dateFormatter = DateFormatter()
        
        // set the dateFormatter for how it will display the date
        dateFormatter.dateStyle = .medium
        
        // unwrap the optional releaseDate
